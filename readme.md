...
Richiederà di ragionare sui dati, iniziate con un console.log in un ciclo. 
Poi capite come tener traccia della bici più leggera.
Ad ogni giro di ciclo verificate se è cambiato qualcosa.
